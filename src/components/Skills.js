...
const BUTTON_CLASS =
  'text-white p-2 rounded shadow-md shadow-[#040c16] hover:scale-110 duration-300 z-20';

const Skills = () => {
  return (
    <div name="skills" className="relative w-full py-12 text-[#999]">
      {/* Container */}
      <div className="max-w-[400px] sm:max-w-[500px] md:max-w-[720px] lg:max-w-[960px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 self-center text-center py-8 z-10">
          <div className={BUTTON_CLASS + ' bg-rose-900'}>
            <img className="w-20 mx-auto" src={HTML} alt="HTML icon" />
            <p className="my-4">HTML</p>
          </div>
          <div className={BUTTON_CLASS + ' bg-blue-900'}>
            <img className="w-20 mx-auto" src={CSS} alt="CSS icon" />
            <p className="my-4">CSS</p>
          </div>
          <div className={BUTTON_CLASS + ' bg-amber-500'}>
          ...
          <div className={BUTTON_CLASS + ' bg-red-800'}>
          ...
          <div className={BUTTON_CLASS + ' bg-sky-800'}>
            <img className="w-20 mx-auto" src={ReactImg} alt="React icon" />
            <p className="my-4">REACT</p>
          </div>

          <div className={BUTTON_CLASS + ' bg-slate-600'}>
          ...
          <div className={BUTTON_CLASS + ' bg-indigo-800'}>
            <img className="w-20 mx-auto" src={Tailwind} alt="Tailwind icon" />
            <p className="my-4">TAILWIND</p>
          </div>
          <div className={BUTTON_CLASS + ' bg-lime-600'}>
            <img className="w-20 mx-auto" src={Bash} alt="BASH icon" />
            <p className="my-4">BASH</p>
          </div>
          <div className={BUTTON_CLASS + ' bg-slate-800'}>
